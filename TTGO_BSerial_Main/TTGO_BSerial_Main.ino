...
void battery_bar(float volts)
{
  ...
  if(volts > 48.8 && volts < 51)
  {
      ...
      pixels.setPixelColor(5, pixels.Color(10, i, 0));
      pixels.setPixelColor(4, pixels.Color(10, i, 0));
      pixels.setPixelColor(3, pixels.Color(10, i, 0));
      pixels.setPixelColor(2, pixels.Color(10, i, 0));
      pixels.setPixelColor(1, pixels.Color(10, i, 0));
  ...
  if(volts > 46.6 && volts < 48.8)
  {
      ...
      pixels.setPixelColor(5, pixels.Color(51, i, 0));
      pixels.setPixelColor(4, pixels.Color(51, i, 0));
      pixels.setPixelColor(3, pixels.Color(51, i, 0));
      pixels.setPixelColor(2, pixels.Color(51, i, 0));
  ...
  if(volts > 44.4 && volts < 46.6)
  {
      ...
      pixels.setPixelColor(5, pixels.Color(102, i, 0));
      pixels.setPixelColor(4, pixels.Color(102, i, 0));
      pixels.setPixelColor(3, pixels.Color(102, i, 0));
  ...
  if(volts > 42.2 && volts < 44.4)
  {
      ...
      pixels.setPixelColor(5, pixels.Color(160, i, 0));
      pixels.setPixelColor(4, pixels.Color(160, i, 0));
  ...
  if(volts > 40 && volts < 42.2)
  {
      ...
      pixels.setPixelColor(5, pixels.Color(254, 0, 0));
